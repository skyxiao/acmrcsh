...
//DI
SystemData<unsigned> diAlcPrsULmt(0, "diAlcPrsULmt", "DI", 0, 1, 0, 0, 0, 0, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diAlcPrsLLmt(1, "diAlcPrsLLmt", "DI", 0, 1, 0, 0, 0, 1, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diAlcTkPrsULmt(2, "diAlcTkPrsULmt", "DI", 0, 1, 0, 0, 0, 2, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diAlcTkPrsLLmt(3, "diAlcTkPrsLLmt", "DI", 0, 1, 0, 0, 0, 3, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diHFSplPrsULmt(4, "diHFSplPrsULmt", "DI", 0, 1, 0, 0, 0, 4, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diHFSplPrsLLmt(5, "diHFSplPrsLLmt", "DI", 0, 1, 0, 0, 0, 5, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diN2PgHFPrsULmt(6, "diN2PgHFPrsULmt", "DI", 0, 1, 0, 0, 0, 6, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diN2PgHFPrsLLmt(7, "diN2PgHFPrsLLmt", "DI", 0, 1, 0, 0, 0, 7, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diN2PgAlcTkPrsULmt(8, "diN2PgAlcTkPrsULmt", "DI", 0, 1, 0, 0, 0, 8, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diN2PgAlcTkPrsLLmt(9, "diN2PgAlcTkPrsLLmt", "DI", 0, 1, 0, 0, 0, 9, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diN2PgExpCbPrsULmt(10, "diN2PgExpCbPrsULmt", "DI", 0, 1, 0, 0, 0, 10, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diN2PgExpCbPrsLLmt(11, "diN2PgExpCbPrsLLmt", "DI", 0, 1, 0, 0, 0, 11, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diN2SplVPumpPrsULmt(12, "diN2SplVPumpPrsULmt", "DI", 0, 1, 0, 0, 0, 12, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diN2SplVPumpPrsLLmt(13, "diN2SplVPumpPrsLLmt", "DI", 0, 1, 0, 0, 0, 13, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diN2PgPrcCbPrsULmt(14, "diN2PgPrcCbPrsULmt", "DI", 0, 1, 0, 0, 0, 14, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diN2PgPrcCbPrsLLmt(15, "diN2PgPrcCbPrsLLmt", "DI", 0, 1, 0, 0, 0, 15, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diN2FacSplPrsULmt(16, "diN2FacSplPrsULmt", "DI", 0, 1, 0, 0, 0, 16, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diN2FacSplPrsLLmt(17, "diN2FacSplPrsLLmt", "DI", 0, 1, 0, 0, 0, 17, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diN2PgVapPrsULmt(18, "diN2PgVapPrsULmt", "DI", 0, 1, 0, 0, 0, 18, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diN2PgVapPrsLLmt(19, "diN2PgVapPrsLLmt", "DI", 0, 1, 0, 0, 0, 19, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diFacVPrsSwtLLmt(21, "diFacVPrsSwtLLmt", "DI", 0, 1, 0, 0, 0, 21, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diExpCbVPrsSwtULmt(22, "diExpCbVPrsSwtULmt", "DI", 0, 1, 0, 0, 0, 22, 0, 1, false,"",ConvertNot<unsigned>);
SystemData<unsigned> diExpCbVPrsSwtLLmt(23, "diExpCbVPrsSwtLLmt", "DI", 0, 1, 0, 0, 0, 23, 0, 1, false,"",ConvertNot<unsigned>);
