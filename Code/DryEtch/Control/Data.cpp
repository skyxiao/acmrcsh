...
SystemData<unsigned> diPrcCbVacuumFail(37, "diPrcCbVacuumFail", "DI", 0, 1, 0, 0, 0, 36, 0, 1, false,"",ConvertNot<unsigned int>);
...
SystemData<unsigned> diGasBoxHFLeak(43, "diGasBoxHFLeak", "DI", 0, 1, 0, 0, 0, 42, 0, 1, false,"",ConvertNot<unsigned int>);
...
SystemData<unsigned> diPinUp(61, "diPinUp", "DI", 0, 1, 0, 0, 0, 60, 0, 1, false);
SystemData<unsigned> diPinDown(62, "diPinDown", "DI", 0, 1, 0, 0, 0, 61, 0, 1, false);
SystemData<unsigned> diForkVertical(63, "diForkVertical", "DI", 0, 1, 0, 0, 0, 62, 0, 1, false);
SystemData<unsigned> diForkHorizontal(64, "diForkHorizontal", "DI", 0, 1, 0, 0, 0, 63, 0, 1, false);
SystemData<unsigned> diArmIn(65, "diArmIn", "DI", 0, 1, 0, 0, 0, 64, 0, 1, false);
SystemData<unsigned> diArmOut(66, "diArmOut", "DI", 0, 1, 0, 0, 0, 65, 0, 1, false);
...
SystemData<unsigned> diProcCbHFLeak(78, "diProcCbHFLeak","DI",0,1,0,0,0,77,0,1,false,"",ConvertNot<unsigned int>);
SystemData<unsigned> diCDAInletAlarm(79, "diCDAInletAlarm", "DI", 0, 1, 0, 0, 0, 78, 0, 1, false, "", ConvertNot<unsigned int>);
...
SystemData<float> aoAxisStopJerk(7065, "aoAxisStopJerk","Motion",0,100,1,0,7,65,0,32,true,"deg/s3",ConvertMemery<float, unsigned>,ConvertMemery<unsigned, float>);
...
SystemData<float> aoAxisJerk(7077, "aoAxisJerk","Motion",0,100,1,0,7,77,0,32,true,"deg/s3",ConvertMemery<float, unsigned>,ConvertMemery<unsigned, float>);
SystemData<float> aoAxisVelocity(7081, "aoAxisVelocity","Motion",0,100,1,0,7,81,0,32,true,"deg/s",ConvertMemery<float, unsigned>,ConvertMemery<unsigned, float>);
SystemData<float> aoAxisPosition(7085, "aoAxisPosition","Motion",0,100,1,0,7,85,0,32,true,"deg",ConvertMemery<float, unsigned>,ConvertMemery<unsigned, float>);
SystemData<float> aoAxisDistance(7089, "aoAxisDistance","Motion",0,100,1,0,7,89,0,32,true,"deg",ConvertMemery<float, unsigned>,ConvertMemery<unsigned, float>);
