 ...
 * @author  meizz  
 */  
Date.prototype.formatEx = function(style) {   
  var o = {   
...
//  this.calendarClear = obj;   
  ...
  var today = (calendar.DateMode != pickMode["day"]) ?   
                    ...
                    : new Date();//2008-01-29   
    calendar.ReturnDate(today.formatEx(calendar.dateFormatStyle));   
  }   
...
Calendar.prototype.show = function (dateObj, popControl) {   
  ...
  var now =  new Date();   
  this.date = (dateObj.value.length > 0) ? new Date(dateObj.value.toDate(this.dateFormatStyle)) : now.formatEx(this.dateFormatStyle).toDate(this.dateFormatStyle) ;//2008-01-29 寒羽枫添加 → 若为空则根据dateFormatStyle初始化日期   
...
{   
    var str = '<div id="calendarPanel" style="position: absolute;display: none;z-index:9999; background-color: #FFFFFF;border: 1px solid #CCCCCC;width:224px;font-size:12px;"></div>';   
    if(document.all)   
    {   
