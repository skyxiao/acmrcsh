...
def parse(line):
    pat = {}
    pat[0] = '^SystemData.*?\s+(\w+)\((\d+),\s*"\w+",\s*"([\w/]+)",\s*(.*?),\s*(.*?),\s*(.*?),.*?(true|false),\s*"(.*?)"[,\)]'
    pat[1] = '^SystemData.*?\s+(\w+)\((\d+),\s*"\w+",\s*"([\w/]+)",\s*(.*?),\s*(.*?),\s*(.*?),.*?(true|false)\s*\)'
    pat[2] = '^SystemData.*?\s+(\w+)\((\d+),\s*"\w+",\s*"([\w/]+)",\s*(.*?),\s*(.*?),\s*(.*?),\s*"(.*?)"\)'
    pat[3] = '^SystemData.*?\s+(\w+)\((\d+),\s*"\w+",\s*"([\w/]+)",\s*(.*?),\s*(.*?),\s*(.*?)\)'
    pat[4] = '^SystemData.*?\s+(\w+)\((\d+),\s*"\w+",\s*"([\w/]+)",\s*(.*?),\s*(.*?)\)'
    pat[5] = '^SystemData.*?\s+(\w+)\((\d+),\s*"\w+",\s*"([\w/]+)"\)'
